...
public class SubfragmentFollowerList extends Fragment {

    BaseListViewUserAdapter adapter;
    int userId = -1;

    public SubfragmentFollowerList(int userId) {
        this.userId = userId;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    String url = Global.server_addr + "list/follow?sessionId=" + Global.getSessionId()+"&getFollower=true&targetId="+userId;
