...
public class SubfragmentPersonalHomepage extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        ListViewUserInfoAdapter adapter = new ListViewUserInfoAdapter(getContext());
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    String url = Global.server_addr + "/user?sessionId=" + Global.getSessionId() + "&detailed=true";
                    ...
                    if(responseCode == HttpURLConnection.HTTP_OK) {
                        ...
                        UserInfo userInfo = UserInfo.fromJson(jsonInfo);
